...
export default function BuildReportPage() {
  ...
  const getInitialDashboards = () => {
    const savedDashboards = typeof window !== 'undefined' ? localStorage.getItem('lovableDashboards') : null;
            ...
            {filteredDashboards.length === 0 && searchQuery ? (
              ...
              filteredDashboards.map((dashboard, index) => (
                ...
                >
                  {dashboard.imageUrl ? (
                    <img
                      src={typeof dashboard.imageUrl === 'string' ? dashboard.imageUrl : dashboard.imageUrl.src}
                      alt={dashboard.name}
