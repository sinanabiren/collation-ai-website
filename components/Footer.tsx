      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <Link href="/" className="inline-block">
              <span className="text-2xl font-bold text-foreground">collation.ai</span>
            </Link>
          </div>

          <div>
            <h3 className="font-semibold text-muted-foreground mb-4 text-sm">Quick Links</h3>
          ...
          <div>
            <h3 className="font-semibold text-muted-foreground mb-4 text-sm">Resources</h3>
            <ul className="space-y-3">
              <li>
              ...
              <li>
                <Link href="/privacy-policy" className="text-foreground hover:text-primary transition-colors font-medium">
                  Privacy Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a 
              href="https://www.linkedin.com/company/collationai/" 
              target="_blank" 
            ...
            <a 
              href="https://www.youtube.com/@CollationAI" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors"
              aria-label="YouTube"
